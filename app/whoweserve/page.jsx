    ...
    <section className="relative overflow-hidden">
      <div className="absolute left-0">
        <div className="relative">
          ...
          >
            <path
              d="M663.749 262.674L278.394 965H-49L479.901 0H808L663.749 262.674Z"
      ...
      <div className="absolute right-0">
        <div className="relative">
          ...
          >
            <path
              d="M143.931 262.674L529.823 965H857L328.233 0H0L143.958 262.674H143.931Z"
      ...
      <div className="relative mx-auto max-w-5xl px-4 py-10 sm:py-20 lg:py-24">
        <div className="text-left">
          <h2 className="text-3xl font-medium tracking-tight text-[#390a74] sm:text-4xl">
            Who We <span className="font-semibold bg-gradient-to-r from-[#3f1685] via-[#743db8] to-[#760272] bg-clip-text text-transparent">Serve</span>
          </h2>
          <p className="mt-3 text-black text-xl">From startups to skyscrapers—our clients shape the built world.</p>
        </div>
        <div className="relative mx-auto mt-25 grid h-[520px] w-full max-w-3xl place-items-center scale-[1.1] -translate-y-[2rem]">
          <div
            className="pointer-events-none absolute h-[640px] w-[170px] -rotate-45 rounded-full bg-gradient-to-r from-[#A0B0DA] to-[#6982C4] border border-white"
            style={{ opacity: 1, transform: 'none' }}
          />
          <div
            className="pointer-events-none absolute h-[640px] w-[170px] rotate-45 rounded-full bg-gradient-to-r from-[#A0B0DA] to-[#7486B5] border border-white"
            style={{ opacity: 1, transform: 'none' }}
          />
          <div
              ...
              >
                <g filter="url(#filter0_d_1_238)">
                  <rect
                    ...
                    height="240.981"
                    rx="26"
                    transform="rotate(44.9182 164.156 -10)"
                    fill="white"
                  />
                  <rect
                    x="164.157"
                    ...
                    height="239.981"
                    rx="25.5"
                    transform="rotate(44.9182 164.157 -9.29289)"
                    stroke="#E0E0E0"
                  />
                </g>
                <defs>
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <feBlend
                          mode="normal"
                          in2="BackgroundImageFix"
                          result="effect1_dropShadow_1_245"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-15">
                  ...
                  >
                    <g filter="url(#filter0_d_1_250)">
                      <path
                        d="M107.875 74.8125C109.843 74.8125 111.438 73.2175 111.438 71.25C111.438 69.2825 109.843 67.6875 107.875 67.6875C105.907 67.6875 104.312 69.2825 104.312 71.25C104.312 73.2175 105.907 74.8125 107.875 74.8125Z"
                        fill="#8A486E"
                      />
                      <path
                        d="M8.125 74.8125C10.0925 74.8125 11.6875 73.2175 11.6875 71.25C11.6875 69.2825 10.0925 67.6875 8.125 67.6875C6.15749 67.6875 4.5625 69.2825 4.5625 71.25C4.5625 73.2175 6.15749 74.8125 8.125 74.8125Z"
                        fill="#8A486E"
                      />
                      <path
                        d="M86.5001 92.6249C82.7507 92.62 79.0685 91.6289 75.8232 89.7511C72.5779 87.8733 69.8836 85.1749 68.0107 81.9268L61.8369 85.4893C66.7639 94.0036 75.9551 99.7499 86.5001 99.7499C97.0451 99.7499 106.236 94.0072 111.163 85.4893L104.989 81.9268C103.117 85.1749 100.422 87.8733 97.177 89.7511C93.9317 91.6289 90.2495 92.62 86.5001 92.6249Z"
                        fill="#8A486E"
                      />
                      <path
                        d="M86.5001 49.875C90.2513 49.8817 93.9351 50.8721 97.1839 52.7475C100.433 54.6228 103.133 57.3175 105.014 60.5625L111.185 56.9964C106.101 48.2077 96.6426 42.75 86.5001 42.75C76.3577 42.75 66.8993 48.2077 61.7835 57.0534L48.0145 81.9375C44.2026 88.5281 37.1096 92.625 29.5001 92.625C21.8906 92.625 14.7977 88.5281 10.9858 81.9375L4.81201 85.5036C9.89926 94.2922 19.3577 99.75 29.5001 99.75C39.6426 99.75 49.101 94.2923 54.2168 85.4466L67.9858 60.5625C71.7977 53.9719 78.8906 49.875 86.5001 49.875Z"
                        fill="#8A486E"
                      />
                      <path
                        d="M29.5001 49.875C33.2495 49.8799 36.9317 50.871 40.177 52.7488C43.4223 54.6266 46.1166 57.325 47.9895 60.5732L54.1633 57.0107C49.2364 48.4963 40.0451 42.75 29.5001 42.75C18.9551 42.75 9.76385 48.4963 4.83691 57.0107L11.0107 60.5732C12.8836 57.325 15.5779 54.6266 18.8232 52.7488C22.0685 50.871 25.7507 49.8799 29.5001 49.875ZM58.0001 21.375C62.6782 21.372 67.3109 22.2933 71.632 24.0858C75.953 25.8783 79.8775 28.5068 83.1798 31.8203L88.2101 26.79C80.4723 19.0451 69.7849 14.25 58.0001 14.25C46.2154 14.25 35.5278 19.0451 27.7865 26.7864L32.8204 31.8203C36.1227 28.5068 40.0471 25.8783 44.3682 24.0858C48.6893 22.2933 53.322 21.372 58.0001 21.375Z"
                        fill="#8A486E"
                      />
                    </g>
                    <defs>
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <feBlend
                          mode="normal"
                          in2="BackgroundImageFix"
                          result="effect1_dropShadow_1_251"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                          in2="effect1_dropShadow_1_251"
                          result="shape"
                        />
                      </filter>
                    </defs>
