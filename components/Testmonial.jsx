      ...
      <div className="relative w-full h-full ">
        ...
        <div className="relative  w-full flex flex-col items-center py-20 overflow-hidden">
          ...
          <div className="flex justify-center items-center pt-20 relative z-10">
            <button
              className="text-white text-[24px] md:text-[32px] rounded-[47px] shadow-xl cursor-pointer w-[180px] h-[42px] md:w-[259px] md:h-[51px] sheen-effect"
              style={{
                background:
                  "linear-gradient(-106.4deg, #47099F 0.28%, #F8AD1D 158.99%)",
                boxShadow: "0px 4px 4px 0px #00000040",
          ...
          {/* Testimonials Section */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-20 mt-20 md:px-10 relative z-10">
            {testimonials.map((item) => (
              <motion.div
                key={item.id}
