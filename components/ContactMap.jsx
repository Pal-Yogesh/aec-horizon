      ...
      <div>
        <div>
          <div className="flex justify-center items-center">
            <h1 className="w-[40%] font-semibold text-[29px] gradient-text text-center">
          ...
          <div className="flex justify-center  gap-14 pt-10 ">
            {/* text */}
            <div className="w-[258px] pt-9">
              <p className="font-semibold text-[29px] gradient-text ">
                HEADQUARTERS
              </p>

              <div className="flex flex-col gap-2 text-[#4B336D] text-[19px] w-[100%] ">
