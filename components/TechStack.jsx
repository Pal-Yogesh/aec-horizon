          ...
          <div className="flex justify-center gap-3 md:gap-14 ">
            <div className="grid grid-cols-2 md:flex md:justify-center gap-2 md:gap-3 relative z-10 max-w-[340px] md:max-w-none">
              {softwareDataTop.map((software) => (
                <div
                  key={software.id}
                  className="group w-[160px] h-[170px] md:w-[200px] md:h-[220px] rounded-[22px] md:rounded-[29px] text-center pt-2 md:pt-3 px-2 border-2 border-[#7595ffad] hover:border-white transition-all duration-300 hover:scale-105 cursor-pointer"
                  style={{
                    background:
          ...
          <div className="flex justify-center gap-3 md:gap-14">
            <div className="grid grid-cols-2 md:flex md:justify-center gap-2 md:gap-3 relative z-10 max-w-[340px] md:max-w-none">
              {softwareDataCenter.map((software) => (
                <div
                  key={software.id}
                  className="group w-[160px] h-[170px] md:w-[199px] md:h-[205px] rounded-[22px] md:rounded-[29px] text-center pt-2 md:pt-3 px-2 border-2 border-[#7595ffad] hover:border-white transition-all duration-300 hover:scale-105 cursor-pointer"
                  style={{
                    background:
                      "radial-gradient(64.61% 64.61% at 59.41% 35.39%, #DAE3FF 0%, #FFFFFF 100%)",
                    boxShadow: "0px 8px 4px 0px #00000040",
          ...
          <div className="flex justify-center gap-3 md:gap-14">
            <div className="grid grid-cols-2 md:flex md:justify-center gap-2 md:gap-3 relative z-10 max-w-[340px] md:max-w-none">
              {softwareDataBottom.map((software) => (
                <div
                  key={software.id}
                  className="group w-[160px] h-[170px] md:w-[199px] md:h-[213px] rounded-[22px] md:rounded-[29px] text-center pt-2 md:pt-3 px-2 border-2 border-[#7595ffad] hover:border-white transition-all duration-300 hover:scale-105 cursor-pointer"
                  style={{
                    background:
                      "radial-gradient(64.61% 64.61% at 59.41% 35.39%, #DAE3FF 0%, #FFFFFF 100%)",
                    boxShadow: "0px 8px 4px 0px #00000040",
