        ...
        <div>
          <div>
            ...
            <div className="flex justify-center items-center gap-3  sm:pt-12 lg:pt-14 pb-3 sm:pb-4">
              ...
              >
                <h1 className="text-[#4B336D] text-[14px] sm:text-[15px] lg:text-[16px]">
                  Contact Us
                </h1>
              </div>
            </div>
            ...
            <div className="w-full lg:flex lg:justify-center lg:items-center ">
              <div className="flex flex-col lg:flex-row justify-center items-center  lg:gap-28 pt-6 sm:pt-8">
                <div className="mb-8 lg:mb-0 mt-16 lg:mt-0 order-2 lg:order-1">
                  <div className="flex justify-center lg:justify-start items-center ">
                    <div>
                      <h2 className="gradient-text lg:w-[450px] font-semibold text-[22px] sm:text-[25px] md:text-[27px] lg:text-[29px] leading-tight text-center lg:text-left">
                        Our experts are always ready to connect, collaborate and
                        provide clarity for your AEC goals. Just drop a message!
                      </h2>
                    </div>
                  </div>
                  ...
                  <div className="w-full flex flex-col items-center">
                    ...
                    <div className="mt-6 sm:mt-7 lg:mt-8 w-full flex justify-center">
                      <form
                        ...
                        className="w-full max-w-[320px] sm:max-w-[340px] lg:w-auto"
                      >
                        <div
