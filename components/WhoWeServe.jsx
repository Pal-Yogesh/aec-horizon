...
const WhoWeServe = () => {
  ...
  const controlsCard4 = useAnimation();
  ...
  useEffect(() => {
    if (isInView) {
      ...
      setTimeout(() => controlsCenter.start("visible"), 200);
      setTimeout(() => controlsCard1.start("visible"), 400);
      setTimeout(() => controlsCard2.start("visible"), 600);
      setTimeout(() => controlsCard3.start("visible"), 800);
      setTimeout(() => controlsCard4.start("visible"), 1000);
      setTimeout(() => controlsButton.start("visible"), 1200);
    } else {
      controlsTitle.start("hidden");
      controlsCenter.start("hidden");
      controlsCard1.start("hidden");
      controlsCard2.start("hidden");
      controlsCard3.start("hidden");
      controlsCard4.start("hidden");
        ...
        <div className="relative">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#C7D0EA"></stop>
                <stop offset="1" stopColor="#7F6DC0"></stop>
              </linearGradient>
            </defs>
          </svg>
        </div>
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#47099F"></stop>
                <stop offset="1" stopColor="#F8AD1D"></stop>
              </linearGradient>
            </defs>
          </svg>
        </div>
