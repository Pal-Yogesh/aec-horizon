            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 pt-7 sm:pt-0 sm:gap-8 lg:gap-12 -mt-8 sm:-mt-10 lg:-mt-12">
              {services.map((service, index) => {
                ...
                return (
                  ...
                  >
                    {/* Icon Circle - Positioned Above Card */}
                    <div className="absolute -top-8 sm:-top-10 lg:-top-12 left-[50%] transform -translate-x-1/2 z-10">
                      <div className="relative">
                        {/* Glow Effect */}
                        <div
                          className={`rounded-full blur-xl transition-all duration-500 ${
                    ...
                    {/* Card */}
                    <div
                      className="relative w-full max-w-[280px] sm:w-[246px] backdrop-blur-sm rounded-[12px] pt-8 sm:pt-10 shadow-xl border border-white transition-all duration-500"
                      style={{
                        background:
                          "linear-gradient(180deg, #DCE3FF 0%, #C4D1FF 100%)",
                      }}
