            ...
            {faqData.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  {/* Toggle Button */}
                  <motion.div
                    className="flex-shrink-0 bg-white rounded-full w-[36px] h-[36px] sm:w-[40px] sm:h-[40px] lg:w-[42px] lg:h-[42px] flex items-center justify-center ml-4"
                    style={{ boxShadow: "0px 4px 4px 0px #00000040" }}
                    whileTap={{ scale: 0.9 }}
                ...
                {/* Answer with optimized animation */}
