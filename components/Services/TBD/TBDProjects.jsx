      ...
      <div className="h-full w-full pb-20 flex justify-center items-center">
        <div className="lg:pt-20 w-full md:flex md:flex-col md:items-center md:justify-center">
          ...
          <div className="flex justify-center items-center">
            <div
              className="rounded-[32px] md:rounded-[43px] w-[320px] md:w-[700px] h-[43px] md:h-[70px] bg-[#9C76FF] border-[1px] text-center py-1 font-semibold border-white"
              style={{
                boxShadow: "0px 4px 15.5px 0px #00000040",
              }}
            >
              <p className="text-[20px] md:text-[35px] font-semibold text-white text-center">
          ...
          <div
            className="
              ...
              gap-6 mt-10 scrollbar-thin scrollbar-thumb-[#C299FF] scrollbar-track-[#F3E8FF] pb-4
            "
          >
            <AnimatePresence>
              {blogData.map((blog) => (
