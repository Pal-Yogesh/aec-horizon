      ...
      <div className=" h-full w-full pb-20 flex justify-center items-center">
        <div className="pt-20 px-[20%] ">
          ...
          <div className="flex justify-center items-center">
            <div
              className=" rounded-[43px] w-[700px] h-[70px] bg-[#9C76FF] border-[1px]  text-center py-1 font-semibold text-[25px] border-white"
              style={{
                boxShadow: "0px 4px 15.5px 0px #00000040",
              }}
            >
              <p className=" text-[35px] font-semibold text-white text-center">
