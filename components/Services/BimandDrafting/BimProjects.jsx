  ...
  return (
    <div className="z-20 relative">
      ...
      <div className=" h-full w-full pb-20 flex justify-center items-center">
        <div
          className="lg:pt-20  w-full md:flex  md:flex-col md:items-center md:justify-center "
          // className="pt-20 px-[20%] "
        >
          {/* Header */}
          <div className="flex justify-center items-center">
            <div
              className=" rounded-[32px] md:rounded-[43px] w-[320px]   md:w-[700px] h-[43px] md:h-[70px] bg-[#B8C7FF] border-[1px]  text-center py-1 font-semibold text-[25px] border-white"
              style={{
                boxShadow: "0px 4px 15.5px 0px #00000040",
              }}
            >
              <p className=" text-[20px] md:text-[35px] font-semibold text-[#374688] text-center">
          ...
          <div
           ...
           gap-6 mt-10 scrollbar-thin scrollbar-thumb-[#92B3FF] scrollbar-track-[#E3E9FF] pb-4
         "
            //  className="flex sm:grid  sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10  "
          >
            <AnimatePresence>
              {blogData.map((blog) => (
                <motion.div
